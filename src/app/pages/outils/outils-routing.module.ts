...
import { estabAndContactPerson, establissementGuard } from 'src/app/core/guards/auth.guard';
import { QrcodeComponent } from './qrcode/qrcode.component';

const routes: Routes = [
    { path: '', redirectTo: 'images-video', pathMatch: 'full' },
    { path: 'images-video', component: ImagesVideoComponent, canActivate: [estabAndContactPerson]  },
